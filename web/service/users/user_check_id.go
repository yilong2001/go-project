...
// func checkJobIdWithParamsForModify(headParams *reqparamodel.HttpReqParams, r render.Render) bool {
// 	log.Println("userid:" + headParams.RouterParams["UserId"])
// 	log.Println("jobid:" + headParams.RouterParams["JobId"])
// 	log.Println("serviceid:" + headParams.RouterParams["ServiceId"])
...
// func checkJobIdWithParamsForQuery(headParams *reqparamodel.HttpReqParams, r render.Render) bool {
// 	log.Println("userid:" + headParams.RouterParams["UserId"])
// 	log.Println("jobid:" + headParams.RouterParams["JobId"])
// 	log.Println("serviceid:" + headParams.RouterParams["ServiceId"])
...
// func checkServiceIdWithParamsForQuery(headParams *reqparamodel.HttpReqParams, r render.Render) bool {
// 	log.Println("userid:" + headParams.RouterParams["UserId"])
// 	log.Println("jobid:" + headParams.RouterParams["JobId"])
// 	log.Println("serviceid:" + headParams.RouterParams["ServiceId"])
